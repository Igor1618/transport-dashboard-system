...
const ROLE_MENUS: Record<string, { href: string; label: string; icon: any }[]> = {
  ...
  mechanic: [
    { href: "/hr/hiring-request", label: "Нужны водители", icon: Users },
    { href: "/maintenance/health", label: "🛠️ Здоровье парка", icon: Wrench },
    { href: "/maintenance", label: "🔧 ТО и ремонт", icon: Wrench },
    { href: "/vehicles", label: "🚗 Машины", icon: TruckIcon },
    { href: "/parts", label: "📦 Запчасти", icon: Package },
  ...
  mechanic_senior: [
    ...
    { href: "/hr/driver-resource", label: "Штаб найма", icon: Users },
    { href: "/maintenance/health", label: "🛠️ Здоровье парка", icon: Wrench },
...
const FULL_MENU: MenuItem[] = [
  ...
  { href: "/hr/hiring-request", label: "Нужны водители", icon: Users, group: "🚗 ПАРК" },
  { href: "/hr/avito", label: "HR Авито", icon: UserCheck, group: "🚗 ПАРК" },
  { href: "/hr/driver-resource", label: "Штаб найма", icon: Users, group: "🚗 ПАРК" },
