...
const menuItems = [
  ...
  { href: "/fuel", label: "Топливо", icon: Fuel, roles: ["director", "accountant", "mechanic_senior"] },
  ...
  { href: "/dispatch/track", label: "Треки", icon: Navigation, roles: ["director", "mechanic", "mechanic_senior", "dispatcher"] },
  ...
  { href: "/finance", label: "Где деньги", icon: DollarSign, roles: ["director"] },
  { href: "/pnl", label: "P&L", icon: DollarSign, roles: ["director"] },
  { href: "/pnl/vehicles", label: "P&L Машины", icon: Truck, roles: ["director"] },
